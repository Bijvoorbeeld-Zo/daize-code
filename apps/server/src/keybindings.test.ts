import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@daize/contracts";
    ...
    Layer.provideMerge(
      Layer.effect(
        ...
        Effect.gen(function* () {
          ...
          const dir = yield* fs.makeTempDirectoryScoped({ prefix: "daize-server-config-test-" });
