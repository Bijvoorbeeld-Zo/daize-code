...
import { CheckpointRef } from "@daize/contracts";
  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = (input) =>
    Effect.gen(function* () {
      ...
      yield* Effect.acquireUseRelease(
        fs.makeTempDirectory({ prefix: "daize-fs-checkpoint-" }),
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "Daize",
              GIT_AUTHOR_EMAIL: "daize@users.noreply.github.com",
              GIT_COMMITTER_NAME: "Daize",
              GIT_COMMITTER_EMAIL: "daize@users.noreply.github.com",
            };
            ...
            const message = `daize checkpoint ref=${input.checkpointRef}`;
