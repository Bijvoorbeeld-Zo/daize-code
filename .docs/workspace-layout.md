...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@daize/shared/git`, `@daize/shared/DrainableWorker`) — no barrel index.
